...
@section('dashboard-content')
    ...
    <nav class="flex" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="#" class="text-sm font-medium text-gray-700 ms-1 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Customers</a>
            </div>
        </li>
    ...
    <form action="{{route('customers.store')}}" method="POST" class="mt-5">
        @csrf
        <div class="mt-3">
